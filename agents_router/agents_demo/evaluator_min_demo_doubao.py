...
# Evaluator 输入（按你当前约定）
FIRST_FRAME_PATH  = "/home/cyt/RoboRouter/RoboRouter_RoboTwin/agents/frames_to_push/f_0.jpg"
MIDDLE_FRAME_PATH = "/home/cyt/RoboRouter/RoboRouter_RoboTwin/agents/frames_to_push/f_80.jpg"
LAST_FRAME_PATH   = "/home/cyt/RoboRouter/RoboRouter_RoboTwin/agents/frames_to_push/f_399.jpg"  # 若无可换成 f_160.jpg
...
def build_instruction() -> str:
    # 只产出一段中文 VQA 摘要；不做结构化；失败时明确失败表现。
    return (
        "你是评估器。根据给定的三帧图像（首帧/中帧/末帧）和外部信号，"
        "用中文写一段2-4句的简短摘要，说明本次任务执行过程与结果。"
